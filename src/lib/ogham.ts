...
const Strokes = ['h2h-2', 'h-2h2', 'h-1h2h-1', 'l-2-.5 4 1-2-.5', 'v-1'] as const;
const SplitStrokes = ['h2m-2 0', 'm-2 0h2', 'm-1 0h2m-1 0', 'm-2-.5l4 1m-2-.5', 'v-1'] as const;
...
function drawPath({ letterStemFirst = true, strokes = Strokes }: { letterStemFirst?: boolean, strokes?: typeof Strokes | typeof SplitStrokes }) {
